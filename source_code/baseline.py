...
def detect_breakpoints_5(first_order_derivative,second_order_derivative, noise_threshold):
    breakpoints=[]
#     denoised_first_order_derivative=[]
    std_1=statistics.stdev(first_order_derivative)
    std_2=statistics.stdev(second_order_derivative)
...
def detect_breakpoints_6(pressure_df,colum_names:Dict[str,List[str]], noise_threshold:float,window_time_duration:float,close_zero_threshold:float)->List[int]:
    """
    Args:
        window_time_duration: in hours
